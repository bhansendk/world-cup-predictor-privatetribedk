    ...
    <div className="tab-content">
      <div className="section-header">
        ...
        <div className="submit-row" style={{ marginTop: 12 }}>
          <button className="btn-accent btn-sm" onClick={() => onRandomFillAll?.()} disabled={isLocked}>🎲 Udfyld alt tilfældigt</button>
          <button className="btn-ghost btn-sm" onClick={() => onResetGroups?.()} disabled={isLocked}>🧹 Nulstil grupper</button>
